...
<style>
  :root { --brand: #7a3b12; --brand-bg: #7a3b12; --brand-contrast: #fff; --text: #333; --bg: #fdfbf7; }
  @media (prefers-color-scheme: dark) {
    :root { --brand: #e0a55f; --brand-bg: #7a3b12; --brand-contrast: #fff; --text: #ece7dc; --bg: #171b19; }
  }
  body { margin: 0; padding: 24px 18px 48px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 15px; line-height: 1.6; color: var(--text); background: var(--bg); }
